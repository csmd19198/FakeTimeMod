...
2. Place `faketimemod-1.1.2-1.21.1-neoforge.jar` in the `mods` folder of your game directory.
3. Launch the game.
...
The build artifact is at `build/libs/faketimemod-1.1.2-1.21.1-neoforge.jar`.
