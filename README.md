...
| 控件 | 说明 |
|------|------|
| **时间滑块** | 水平滑动条，左端 = 6:00 AM（0 刻），右端 = 5:59 AM（23999 刻）。拖动滑块即可立即改变世界时间显示。拖动后自动进入 **独立模式**。 |
...
Minecraft 一天 = 24000 游戏刻（ticks），1000 刻 = 1 游戏小时（游戏时钟换算用；按现实时间计约 50 秒）。0 刻为日出（6:00 AM）。

| 游戏刻 | 现实时间 | 说明 |
|--------|----------|------|
| 0 | 6:00 AM | 日出（默认一天开始） |
| 6000 | 12:00 PM | 正午，太阳最高 |
| 12000 | 6:00 PM | 日落 |
| 18000 | 12:00 AM | 午夜 |
| 24000 | 6:00 AM | 次日日出（等同于 0 刻） |
