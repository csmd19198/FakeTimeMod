...
The build artifact is located at `build/libs/faketimemod-1.1.2-1.20.1.jar` (Forge 1.20.1) or `build/libs/faketimemod-1.1.2-1.21.1-neoforge.jar` (NeoForge 1.21.1, built on the `neoforge-1.21.1` branch).
